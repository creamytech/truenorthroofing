...
export function StatsSection() {
  return (
    <section className="section-padding bg-slate-50 dark:bg-gradient-to-b dark:from-slate-950 dark:to-slate-900 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-4xl mx-auto">
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="text-center p-6 rounded-2xl bg-white/50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 hover:border-blue-500/30 transition-colors"
            >
