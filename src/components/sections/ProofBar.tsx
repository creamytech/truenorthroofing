...
export function ProofBar() {
  return (
    <section className="py-8 border-y border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/50">
          ...
          {trustItems.map((item) => (
            <StaggerItem key={item.label}>
              <motion.div
                ...
                className="flex items-center gap-3 px-5 py-3 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 shadow-sm hover:shadow-md hover:border-blue-500/40 transition-all cursor-default"
              >
