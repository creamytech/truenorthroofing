...
function generateCustomerConfirmationHTML(data: InspectionFormData): string {
  return `
<!DOCTYPE html>
<html>
<head>
          ...
          <tr>
            <td style="padding: 32px;">
              ...
              <p style="margin: 0 0 24px; color: #cbd5e1; font-size: 15px; line-height: 1.6;">
                Thank you for requesting a <strong style="color: #22c55e;">FREE roof inspection</strong> from True North Roofing & Construction! Our team will contact you within <strong style="color: #f59e0b;">24 hours</strong> to confirm your appointment.
              </p>
              
              <!-- Property Details -->
              <div style="background: linear-gradient(135deg, #1e3a5f 0%, #0f172a 100%); border: 2px solid #3b82f6; border-radius: 12px; padding: 20px; margin: 24px 0;">
                <p style="margin: 0 0 8px; color: #60a5fa; font-size: 12px; text-transform: uppercase; letter-spacing: 1px;">📍 Inspection Address</p>
                <p style="margin: 0; color: #f1f5f9; font-size: 18px; font-weight: 600;">${data.address}</p>
              </div>
              
              <p style="margin: 0 0 16px; color: #cbd5e1; font-size: 15px; line-height: 1.6;">
                <strong style="color: #f1f5f9;">What to expect:</strong>
              </p>
              <ul style="margin: 0 0 24px; padding-left: 20px; color: #94a3b8; font-size: 14px; line-height: 1.8;">
                <li>A thorough inspection of your entire roof</li>
                <li>Detailed photo documentation</li>
                <li>Honest assessment of any issues found</li>
                <li>No pressure, no obligation</li>
              </ul>
              
              <p style="margin: 0 0 24px; color: #cbd5e1; font-size: 15px; line-height: 1.6;">
                Need to reschedule or have questions? Give us a call:
              </p>
...
export async function POST(request: NextRequest) {
  try {
    ...
    await resend.emails.send({
      from: 'True North Roofing <noreply@truenorth-tx.co>',
      to: [body.email],
      subject: 'Your Free Inspection Request - True North Roofing',
